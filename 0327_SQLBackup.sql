USE [master]
GO
/****** Object:  Database [FormSystemDB]    Script Date: 2022/3/27 下午 04:05:17 ******/
...
USE [FormSystemDB]
GO
/****** Object:  Table [dbo].[FormData]    Script Date: 2022/3/27 下午 04:05:17 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[FormInfo]    Script Date: 2022/3/27 下午 04:05:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FormLayout]    Script Date: 2022/3/27 下午 04:05:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FrenquenQuestion]    Script Date: 2022/3/27 下午 04:05:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[QuestionType]    Script Date: 2022/3/27 下午 04:05:17 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[FormData] ([DataID], [FormID], [CreateDate], [AnswerData], [QuestionSort]) VALUES (1021, N'35a69dc7-7627-49a2-b3ed-01b143a8fa52', CAST(N'2022-03-27T10:04:17.160' AS DateTime), N'滿意;', N'QT05 ;')
GO
SET IDENTITY_INSERT [dbo].[FormData] OFF
GO
INSERT [dbo].[FormInfo] ([FormID], [Name], [Body], [StartDate], [EndDate], [CreateDate]) VALUES (N'35a69dc7-7627-49a2-b3ed-01b143a8fa52', N'測試用1001', N'測試用1001', CAST(N'2022-03-01T00:00:00.000' AS DateTime), CAST(N'2022-03-31T00:00:00.000' AS DateTime), CAST(N'2022-03-27T10:04:06.290' AS DateTime))
GO
...
GO
INSERT [dbo].[FormInfo] ([FormID], [Name], [Body], [StartDate], [EndDate], [CreateDate]) VALUES (N'9f702780-8860-4410-9c5e-51b8573c9cbf', N'Add Form 1', N'Add Form 1', CAST(N'2022-03-01T00:00:00.000' AS DateTime), CAST(N'2022-04-30T00:00:00.000' AS DateTime), CAST(N'2022-03-26T11:49:57.733' AS DateTime))
GO
...
GO
INSERT [dbo].[FormInfo] ([FormID], [Name], [Body], [StartDate], [EndDate], [CreateDate]) VALUES (N'dfad742c-0cb8-4bdf-8189-5b6ec6a09567', N'Add Form 2', N'Add Form 2', CAST(N'2022-02-01T00:00:00.000' AS DateTime), CAST(N'2022-03-15T00:00:00.000' AS DateTime), CAST(N'2022-03-26T11:50:30.170' AS DateTime))
GO
...
GO
INSERT [dbo].[FormInfo] ([FormID], [Name], [Body], [StartDate], [EndDate], [CreateDate]) VALUES (N'6ea5af38-0f74-4e1a-82ce-e6bd7fa091d5', N'測試用1002', N'測試用1002', CAST(N'2022-03-12T00:00:00.000' AS DateTime), CAST(N'2022-03-19T00:00:00.000' AS DateTime), CAST(N'2022-03-27T10:05:51.287' AS DateTime))
GO
...
GO
INSERT [dbo].[FormLayout] ([ID], [FormID], [QuestionType], [Body], [Answer], [NeedAns], [QuestionSort]) VALUES (1055, N'9f702780-8860-4410-9c5e-51b8573c9cbf', N'QT05 ', N'年齡', N'~18;19~22;22~26;27~30;31~34;35~38', 0, 1)
GO
INSERT [dbo].[FormLayout] ([ID], [FormID], [QuestionType], [Body], [Answer], [NeedAns], [QuestionSort]) VALUES (1056, N'9f702780-8860-4410-9c5e-51b8573c9cbf', N'QT04 ', N'文字方塊(日期)', NULL, 0, 2)
GO
INSERT [dbo].[FormLayout] ([ID], [FormID], [QuestionType], [Body], [Answer], [NeedAns], [QuestionSort]) VALUES (1057, N'9f702780-8860-4410-9c5e-51b8573c9cbf', N'QT01 ', N'名稱:', NULL, 0, 3)
GO
INSERT [dbo].[FormLayout] ([ID], [FormID], [QuestionType], [Body], [Answer], [NeedAns], [QuestionSort]) VALUES (1058, N'dfad742c-0cb8-4bdf-8189-5b6ec6a09567', N'QT05 ', N'滿意度', N'非常不滿意;不滿意;普通;滿意;非常滿意', 1, 1)
GO
INSERT [dbo].[FormLayout] ([ID], [FormID], [QuestionType], [Body], [Answer], [NeedAns], [QuestionSort]) VALUES (1059, N'dfad742c-0cb8-4bdf-8189-5b6ec6a09567', N'QT05 ', N'年齡', N'~18;19~22;22~26;27~30;31~34;35~38', 0, 2)
GO
INSERT [dbo].[FormLayout] ([ID], [FormID], [QuestionType], [Body], [Answer], [NeedAns], [QuestionSort]) VALUES (1060, N'dfad742c-0cb8-4bdf-8189-5b6ec6a09567', N'QT06 ', N'興趣', N'運動;學習;看電影;購物;閱讀', 0, 3)
GO
INSERT [dbo].[FormLayout] ([ID], [FormID], [QuestionType], [Body], [Answer], [NeedAns], [QuestionSort]) VALUES (1061, N'dfad742c-0cb8-4bdf-8189-5b6ec6a09567', N'QT03 ', N'Email:', NULL, 0, 4)
GO
INSERT [dbo].[FormLayout] ([ID], [FormID], [QuestionType], [Body], [Answer], [NeedAns], [QuestionSort]) VALUES (2059, N'35a69dc7-7627-49a2-b3ed-01b143a8fa52', N'QT05 ', N'滿意度', N'非常不滿意;不滿意;普通;滿意;非常滿意', 1, 1)
GO
INSERT [dbo].[FormLayout] ([ID], [FormID], [QuestionType], [Body], [Answer], [NeedAns], [QuestionSort]) VALUES (2060, N'6ea5af38-0f74-4e1a-82ce-e6bd7fa091d5', N'QT06 ', N'測試複選方塊', N'選項1;選項2;選項3;選項4', 1, 1)
GO
INSERT [dbo].[FormLayout] ([ID], [FormID], [QuestionType], [Body], [Answer], [NeedAns], [QuestionSort]) VALUES (2061, N'6ea5af38-0f74-4e1a-82ce-e6bd7fa091d5', N'QT06 ', N'測試複選方塊3', N'選項1;選項2;選項3;選項4', 0, 2)
GO
...
GO
INSERT [dbo].[FrenquenQuestion] ([ID], [Name], [Body], [Answer], [QuestionType], [NeedAns]) VALUES (1032, N'滿意度', N'滿意度', N'非常不滿意;不滿意;普通;滿意;非常滿意', N'QT05 ', 1)
GO
INSERT [dbo].[FrenquenQuestion] ([ID], [Name], [Body], [Answer], [QuestionType], [NeedAns]) VALUES (1033, N'年齡', N'年齡', N'~18;19~22;22~26;27~30;31~34;35~38', N'QT05 ', 0)
GO
INSERT [dbo].[FrenquenQuestion] ([ID], [Name], [Body], [Answer], [QuestionType], [NeedAns]) VALUES (1034, N'興趣', N'興趣', N'運動;學習;看電影;購物;閱讀', N'QT06 ', 0)
GO
